package com.iEngg.kafka.stream.processor;

import com.iEngg.kafka.avro.schema.MergedAccountDetail;
import com.iEngg.kafka.joiner.AccountValueJoiner;
...
public class CustomerAccountStreamProcessor {
    ...
    public void joinCustomerAccounts() {
        ...
        KStream<Long, MergedAccountDetail> joinedStream = xyzKStream.outerJoin(abcKStream, new AccountValueJoiner(), JoinWindows.of(Duration.ofSeconds(10)), JoinWindows.ofTimeDifferenceAndGrace(60),StreamJoined.with(Serdes.Long(), this.getSpecificAvroSerde(new SpecificAvroSerde<>()), this.getSpecificAvroSerde(new SpecificAvroSerde<>())));

...
public class LoanDetail extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public ApplicantDetail applicantDetail;
  ...
  @Deprecated public CollateralDetail collateralDetail;
   ...
   */
  public LoanDetail(ApplicantDetail applicantDetail, java.math.BigDecimal approvedLoanAmount, java.lang.CharSequence bankName, java.lang.CharSequence branch, java.lang.CharSequence branchAddress, CollateralDetail collateralDetail, java.lang.Long loanAccountNum, java.lang.CharSequence loanApprovalDate, java.lang.Long loanId, java.lang.CharSequence micrCode, java.math.BigDecimal requestedLoanAmount) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: applicantDetail = (ApplicantDetail)value$; break;
    ...
    case 5: collateralDetail = (CollateralDetail)value$; break;
   ...
   */
  public void setApplicantDetail(ApplicantDetail value) {
   ...
   */
  public static LoanDetail.Builder newBuilder() {
    return new LoanDetail.Builder();
  }
   ...
   * @return A new LoanDetail RecordBuilder
   */
  public static LoanDetail.Builder newBuilder(LoanDetail.Builder other) {
    return new LoanDetail.Builder(other);
  }
   ...
   * @return A new LoanDetail RecordBuilder
   */
  public static LoanDetail.Builder newBuilder(LoanDetail other) {
    return new LoanDetail.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<LoanDetail>
    ...
    private ApplicantDetail.Builder applicantDetailBuilder;
    ...
    private CollateralDetail.Builder collateralDetailBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(LoanDetail.Builder other) {
      super(other);
      ...
      if (other.hasApplicantDetailBuilder()) {
        this.applicantDetailBuilder = ApplicantDetail.newBuilder(other.getApplicantDetailBuilder());
      }
      ...
      if (other.hasCollateralDetailBuilder()) {
        this.collateralDetailBuilder = CollateralDetail.newBuilder(other.getCollateralDetailBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(LoanDetail other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.applicantDetail)) {
        this.applicantDetail = data().deepCopy(fields()[0].schema(), other.applicantDetail);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public LoanDetail.Builder setApplicantDetail(ApplicantDetail value) {
     ...
     * @return This builder.
     */
    public ApplicantDetail.Builder getApplicantDetailBuilder() {
      if (applicantDetailBuilder == null) {
        if (hasApplicantDetail()) {
          setApplicantDetailBuilder(ApplicantDetail.newBuilder(applicantDetail));
        } else {
          setApplicantDetailBuilder(ApplicantDetail.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public LoanDetail.Builder setApplicantDetailBuilder(ApplicantDetail.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public LoanDetail.Builder clearApplicantDetail() {
    ...
    /**
      ...
      * @return This builder.
      */
    public LoanDetail.Builder setApprovedLoanAmount(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public LoanDetail.Builder clearApprovedLoanAmount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public LoanDetail.Builder setBankName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public LoanDetail.Builder clearBankName() {
      bankName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public LoanDetail.Builder setBranch(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public LoanDetail.Builder clearBranch() {
      branch = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public LoanDetail.Builder setBranchAddress(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public LoanDetail.Builder clearBranchAddress() {
      branchAddress = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public LoanDetail.Builder setCollateralDetail(CollateralDetail value) {
     ...
     * @return This builder.
     */
    public CollateralDetail.Builder getCollateralDetailBuilder() {
      if (collateralDetailBuilder == null) {
        if (hasCollateralDetail()) {
          setCollateralDetailBuilder(CollateralDetail.newBuilder(collateralDetail));
        } else {
          setCollateralDetailBuilder(CollateralDetail.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public LoanDetail.Builder setCollateralDetailBuilder(CollateralDetail.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public LoanDetail.Builder clearCollateralDetail() {
    ...
    /**
      ...
      * @return This builder.
      */
    public LoanDetail.Builder setLoanAccountNum(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public LoanDetail.Builder clearLoanAccountNum() {
    ...
    /**
      ...
      * @return This builder.
      */
    public LoanDetail.Builder setLoanApprovalDate(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public LoanDetail.Builder clearLoanApprovalDate() {
    ...
    /**
      ...
      * @return This builder.
      */
    public LoanDetail.Builder setLoanId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public LoanDetail.Builder clearLoanId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public LoanDetail.Builder setMicrCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public LoanDetail.Builder clearMicrCode() {
      micrCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public LoanDetail.Builder setRequestedLoanAmount(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public LoanDetail.Builder clearRequestedLoanAmount() {
    ...
    public LoanDetail build() {
      try {
        ...
        if (applicantDetailBuilder != null) {
          ...
          record.applicantDetail = fieldSetFlags()[0] ? this.applicantDetail : (ApplicantDetail) defaultValue(fields()[0]);
        }
        ...
        if (collateralDetailBuilder != null) {
          ...
          record.collateralDetail = fieldSetFlags()[5] ? this.collateralDetail : (CollateralDetail) defaultValue(fields()[5]);
        }
